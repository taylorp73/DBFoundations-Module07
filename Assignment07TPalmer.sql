...
-- 2022-08-20,TPalmer,Created File
-- 2022-08-24,TPalmer,Completed File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_TPalmer')
	 Begin 
	  Alter Database [Assignment07DB_TPalmer] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_TPalmer;
	 End
	Create Database Assignment07DB_TPalmer;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_TPalmer;
...
Select Top 10000000000000
	...
	InventoryCount,
	PreviousMonthCount,
	PreviousMonthCountKPI = IsNull (Case
...
As
	Return select
			...
			Where PreviousMonthCountKPI=@KPIValue
